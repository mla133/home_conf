...
#export PS1='\[\e[31;40m\](\@)\[\e[m\] \[\e[32;40m\]\W\[\e[m\] \[\e[33;40m\][$(jobcount)]\[\e[m\]\[\e[36;40m\]$(__git_ps1)\e[m\]: \[\e]0;BLAH'
...
# Add .mycolors to colorize directories from dark blue to cyan for readability
source ~/.mycolors
